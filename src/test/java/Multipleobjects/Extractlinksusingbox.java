...
public class Extractlinksusingbox extends TestBase {
    ...
    public static void main(String[] args) {
        ...
        try{
            WebElement box=driver.findElement(By.xpath("//ul[@class='sc-cSHVUG bYPcOh']"));
           List<WebElement> toplinks=box.findElements(By.tagName("a"));
...
//                Assert.isTrue(validateResponsecode(url));
                ...
                driver.get("https://cnn.com");
                System.out.println("***********No stale object exception***************");
               // toplinks=driver.findElements(By.xpath("//*[@id=\"header-nav-container\"]/div/div[1]/div/div[2]/nav/ul/li/a"));
                box=driver.findElement(By.xpath("//ul[@class='sc-cSHVUG bYPcOh']"));
                toplinks=box.findElements(By.tagName("a"));
            }
        }catch(Exception e){
            e.printStackTrace();
        }finally {
